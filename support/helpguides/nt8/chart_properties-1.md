...
|  |
| --- |
| The Chart Properties window can be accessed in the following ways:    1.Left mouse click the Properties button in the chart toolbar  2.Right mouse click within the chart and select the menu item Properties  3.Use the default CTRL + T [Hot Key](hot_key_manager-1.md) |
