...
Once custom performance metrics are created be sure to enable their usage in [Tools > Options > General](../getting_started/general_section.md) or else they will not be available in the [Strategy Analyzer](../strategies/strategy_analyzer.md) or [Trade Performance](../operations/trade_performance.md) windows.
