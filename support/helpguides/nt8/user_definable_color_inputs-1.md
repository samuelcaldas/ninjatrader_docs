...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\user_definable_color_inputs.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Tips](tips-1.htm) >  User Definable Color Inputs | [Previous page](traceorders2-1.htm) [Return to chapter overview](tips-1.htm) [Next page](using__brackets-1.htm) |
