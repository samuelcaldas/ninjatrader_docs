...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](order_instruction_files_oif.htm) >>  **Navigation:**  [Operations](operations.htm) > [Automated Trading](automated_trading.htm) > [Automated Trading Interface (ATI)](automated_trading_interface_at.htm) > [File Interface](file_interface.htm) >  Order Instruction Files (OIF) | [Previous page](file_interface.htm) [Return to chapter overview](file_interface.htm) [Next page](information_update_files.htm) |
...
Please reference the [Commands and Valid Parameters](commands_and_valid_parameters.htm) section for detailed information on available commands and parameters.
