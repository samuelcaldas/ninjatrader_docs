...
![[[tog_minus](../images/tog_minus.gif)        Order Flow VWAP Parameters
...
![[[tog_minus](../images/tog_minus.gif)        Order Flow VWAP Values NinjaScript access

> For information on how to access the Order Flow VWAP values in NinjaScript, please see the [[[Order Flow VWAP](../indicators/order_flow_vwap2.md) page in the NinjaScript section of the Help Guide.
