...
![tog_minus](tog_minus-1.gif)        Simple Moving Average Crossover
...
![tog_minus](tog_minus-1.gif)        Multi-Plot Indicator Crossover
...
![tog_minus](tog_minus-1.gif)        Hot List Analyzer Net Change
...
![tog_minus](tog_minus-1.gif)        New Intraday High
...
![tog_minus](tog_minus-1.gif)        PnL Risk Management
...
![tog_minus](tog_minus-1.gif)        Price and Fibonacci Retracements
...
![tog_minus](tog_minus-1.gif)        Price and User-Drawn Objects
...
![tog_minus](tog_minus-1.gif)        Time-Based Alert
...
![tog_minus](tog_minus-1.gif)        Conditions for custom indicators
