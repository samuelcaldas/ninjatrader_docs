...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_strokestyle_dashcap.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) > [StrokeStyle](sharpdx_direct2d1_strokestyle.htm) >  SharpDX.Direct2D1.StrokeStyle.DashCap | [Previous page](sharpdx_direct2d1_strokestyle.htm) [Return to chapter overview](sharpdx_direct2d1_strokestyle.htm) [Next page](sharpdx_direct2d1_strokestyle_dashescount.htm) |
