...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](cs0200.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Editor](editor.htm) > [Compile Error Codes](compile_error_codes.htm) >  CS0200 | [Previous page](cs0103.htm) [Return to chapter overview](compile_error_codes.htm) [Next page](cs0201.htm) |
