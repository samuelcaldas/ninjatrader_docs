...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\monitoring_stop-loss_and_profi.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Reference Samples](reference_samples-1.htm) > [Strategy](strategy2-1.htm) >  Monitoring Stop-Loss and Profit Target Orders | [Previous page](monitoring_for_and_trading_a_b-1.htm) [Return to chapter overview](strategy2-1.htm) [Next page](plotting_from_within_a_ninjasc-1.htm) |
