...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_pathgeometry.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) >  SharpDX.Direct2D1.PathGeometry | [Previous page](sharpdx_direct2d1_measuringmode.htm) [Return to chapter overview](sharpdx_direct2d1.htm) [Next page](sharpdx_direct2d1_pathgeometry_figurecount.htm) |
