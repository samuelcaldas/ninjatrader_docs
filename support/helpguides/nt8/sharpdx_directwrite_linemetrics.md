...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_directwrite_linemetrics.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.DirectWrite](sharpdx_directwrite.htm) >  SharpDX.DirectWrite.TextLayout.LineMetrics | [Previous page](sharpdx_directwrite_textformat_wordwrapping.htm) [Return to chapter overview](sharpdx_directwrite.htm) [Next page](sharpdx_directwrite_textlayout.htm) |
