...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_brush_opacity.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) > [Brush](sharpdx_direct2d1_brush.htm) >  SharpDX.Direct2D1.Brush.Opacity | [Previous page](sharpdx_direct2d1_brush.htm) [Return to chapter overview](sharpdx_direct2d1_brush.htm) [Next page](sharpdx_direct2d1_brush_transform.htm) |
