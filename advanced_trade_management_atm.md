...
| ATM Strategy  
- [Definition and Benefits](atm_strategy.md)  
...
- [ATM Strategy Templates](manage_atm_strategy_templates.md)  
- [Example #1](tutorial_atm_strategy_example_.md)  
- [Example #2](tutorial_atm_strategy_example2.md) | Advanced Options  
- [Auto Chase](auto_chase.md)  
- [Auto Reverse](auto_reverse.md)  
- [Shadow Strategy](shadow_strategy.md)   Misc  
- [Close at Time](auto_close_position.md)  
- [Indicator Tracking](attachingorderstoindicators.md)  
- [FAQ](faq.md) |
