...
Sets the y-axis value of Drawing Object anchor point(s) to the price, rounded to the nearest tick
...
- If you wish to exclude a Global Drawing Object from one or more charts, you can do so by setting the property "Show global draw objects" to false in the [Format Data Series](../operations/working_with_price_data.md) window on the chart(s) you wish to exclude.

![Drawobjects9](../images/drawobjects9.png)

- Making a draw object global means that the object would be redrawn and thus the [z-order](../language_reference/chartobjects.md) reset to its default.
...
![Drawobjects8](../images/drawobjects8.png)

![Chartdefaults7](../images/chartdefaults7.png)

![Drawobjects3](../images/drawobjects3.png)

![Drawobjects4](../images/drawobjects4.png)
