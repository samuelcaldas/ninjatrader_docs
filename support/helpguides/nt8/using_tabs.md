...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](using_tabs.htm) >>  **Navigation:**  [Operations](operations.htm) > [Windows](window_tabs.htm) >  Using Tabs | [Previous page](instrument_overlay_selector.htm) [Return to chapter overview](window_tabs.htm) [Next page](sharing_content.htm) |
...
![tog_minus](tog_minus.gif)        Duplicating a window and it's tabs
