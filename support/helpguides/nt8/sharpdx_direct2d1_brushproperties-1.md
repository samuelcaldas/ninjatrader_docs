...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_direct2d1_brushproperties.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1-1.htm) >  SharpDX.Direct2D1.BrushProperties | [Previous page](sharpdx_direct2d1_brush_transform-1.htm) [Return to chapter overview](sharpdx_direct2d1-1.htm) [Next page](sharpdx_direct2d1_capstyle-1.htm) |
