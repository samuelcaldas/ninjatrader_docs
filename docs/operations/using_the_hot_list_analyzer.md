...
Grid displays various instrument related information, similar to the [Market Analyzer Columns](../language_reference/market_analyzer_column.md)
...
Set the [Hot List Analyzer properties](hot_list_analyzer_properties.md)
...
![Hot List 2](../images/hot_list_2.png)

![Hot List 1](../images/hot_list_1.png)
