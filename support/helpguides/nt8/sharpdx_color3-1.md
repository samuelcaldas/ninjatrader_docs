...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_color3.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX](sharpdx-1.htm) >  SharpDX.Direct2D1.Color3 | [Previous page](sharpdx_color-1.htm) [Return to chapter overview](sharpdx-1.htm) [Next page](sharpdx_color4-1.htm) |
