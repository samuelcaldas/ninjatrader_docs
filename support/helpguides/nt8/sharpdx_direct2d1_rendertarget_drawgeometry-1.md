...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_direct2d1_rendertarget_drawgeometry.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1-1.htm) > [RenderTarget](sharpdx_direct2d1_rendertarget-1.htm) >  SharpDX.Direct2D1.RenderTarget.DrawGeometry() | [Previous page](sharpdx_direct2d1_rendertarget_drawellipse-1.htm) [Return to chapter overview](sharpdx_direct2d1_rendertarget-1.htm) [Next page](sharpdx_direct2d1_rendertarget_drawline-1.htm) |
...
| geometry | The [SharpDX.Direct2D1.Geometry](sharpdx_direct2d1_pathgeometry-1.htm) to draw |
| strokeStyle | The [SharpDX.Direct2D1.StrokeStyle](sharpdx_direct2d1_strokestyle-1.htm) to apply to the geometry's outline, or null to paint a solid stroke. |
