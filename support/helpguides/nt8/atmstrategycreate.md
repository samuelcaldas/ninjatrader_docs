...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](atmstrategycreate.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Strategy](strategy.htm) > [ATM Strategy Methods](atm_strategy_methods.htm) >  AtmStrategyCreate() | [Previous page](atmstrategyclose.htm) [Return to chapter overview](atm_strategy_methods.htm) [Next page](getatmstrategyentryorderstatus.htm) |
