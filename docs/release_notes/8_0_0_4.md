...
- Strategy IsExitOnCloseStrategy - renamed to [[[IsExitOnSessionCloseStrategy](../strategies/isexitonsessionclosestrategy.md)

- Strategy ExitOnCloseSeconds - renamed to [[[ExitOnSessionCloseSeconds](../strategies/exitonsessioncloseseconds.md)

- Order signal name "Exit on close" - string renamed to "Exit on session close"

- BarsType AddDataPoint() - renamed to [[[AddBar()](../language_reference/addbar.md) (for consistency)

- BarsType IsTickReplaySupported - renamed to [[[IsRemoveLastBarSupported](../language_reference/isremovelastbarsupported.md) (note: the logic changed from default TRUE to FALSE)
