...
![tog_minus](../images/tog_minus.gif)        Update instrument lists

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| Update Instruments Lists This will replace and update all instrument lists to current server definitions.    The NinjaTrader data server maintains definitions for the following instrument lists:
- Dow 30
- FOREX
- Futures
- Indexes
...
![tog_minus](../images/tog_minus.gif)        Reset DB
...
![tog_minus](../images/tog_minus.gif)        Repair DB
