...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\order_instruction_files_oif.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Automated Trading](automated_trading-1.htm) > [Automated Trading Interface (ATI)](automated_trading_interface_at-1.htm) > [File Interface](file_interface-1.htm) >  Order Instruction Files (OIF) | [Previous page](file_interface-1.htm) [Return to chapter overview](file_interface-1.htm) [Next page](information_update_files-1.htm) |
...
Please reference the [Commands and Valid Parameters](commands_and_valid_parameters-1.htm) section for detailed information on available commands and parameters.
