...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\strategy_position_vs__account_.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Tips](tips-1.htm) >  Strategy Position vs. Account Position | [Previous page](referencing_the_correct_bar-1.htm) [Return to chapter overview](tips-1.htm) [Next page](traceorders2-1.htm) |
