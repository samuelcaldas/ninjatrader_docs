...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](8_0_13_1.htm) >>  **Navigation:**  [Release Notes](release_notes.htm) > [8.0](8_0.htm) >  8.0.13.1 | [Previous page](8_0_14_2.htm) [Return to chapter overview](8_0.htm) [Next page](8_0_12_0.htm) |
...
| 12586 | Changed | Indicator, NinjaScript | Order Flow Cumulative Delta previously shared its DeltaType enum with Volumetric Bars which was not ideal for exporting NinjaScript. NinjaScript developers whom utilized the preview release of 'Order Flow +' will require a small signature update: [Order Flow Cumulative Delta](order_flow_cumulative_delta2.htm) |
| 12506 | Changed | Indicator, NinjaScript | Order Flow VWAP now uses Trading Hours template to set custom start/end time. NinjaScript developers whom utilized the preview release of 'Order Flow +' will require a small signature update: [Order Flow VWAP](order_flow_vwap2.htm) |
