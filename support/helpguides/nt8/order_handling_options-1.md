...
![tog_minus](tog_minus-1.gif)        Understanding submit market order on TradeStation fill
...
![tog_minus](tog_minus-1.gif)        Understanding submit "as-is"
...
![tog_minus](tog_minus-1.gif)        Understanding submit and forget
...
![tog_minus](tog_minus-1.gif)        Understanding synchronization time out
...
![tog_minus](tog_minus-1.gif)        How to enable order confirmation
...
![tog_minus](tog_minus-1.gif)        Understanding special handling for FX through FOREX.com/City Index
