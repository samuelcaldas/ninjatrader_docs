...
You can use NinjaScript to draw custom shapes, lines, text and colors on price and indicator panels from both [Indicators](../indicators/indicator.md) and [Strategies](../strategies/strategy.md).
