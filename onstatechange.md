...
- State.Historical is called multiple times when running a backtest [optimization](optimize_a_strategy.md) on a strategy and the property "[IsInstantiatedOnEachOptimizationIteration](isinstantiatedoneachoptimizationiteration.md)" is true (default behavior).
