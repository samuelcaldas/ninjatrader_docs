...
> **Attention TD Ameritrade Users:** here for more information
...
> Features  Added options support for Kinetick, IQFeed, and Interactive Brokers (beta) Kinetick, IQFeed, Interactive Brokers, Options  Feature #13676    With Kinetick, IQFeed, and Interactive Brokers you can now access options on futures and equities. At this time these features are in beta.    r2013676  Major improvements on Portuguese translations and sound files Localization  Feature #14185    Added improvements to Portuguese translations provide a more complete experience for Portuguese clients.

![R2013676](../images/r2013676.png)
