...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\barbrush.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [Drawing](drawing-1.htm) >  BarBrush | [Previous page](backbrushesall-1.htm) [Return to chapter overview](drawing-1.htm) [Next page](barbrushes-1.htm) |
...
|  |
| --- |
| Warning:  You may have up to 65,535 unique BarBrush instances, therefore, using [static predefined brushes](working_with_brushes-1.htm) should be favored.  Alternatively,  in order to use fewer brushes, please try to cache your custom brushes until a new brush would actually need to be created. |
