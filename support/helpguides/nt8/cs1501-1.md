...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\cs1501.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Editor](editor-1.htm) > [Compile Error Codes](compile_error_codes-1.htm) >  CS1501 | [Previous page](cs1061-1.htm) [Return to chapter overview](compile_error_codes-1.htm) [Next page](cs1502-1.htm) |
