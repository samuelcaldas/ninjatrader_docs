...
![tog_minus](../images/tog_minus.gif)        Reordering tabs

> Reordering Tabs Click and hold to drag the tab into the desired position in the tab area.

![tog_minus](../images/tog_minus.gif)        Tabs actions
...
![tog_minus](../images/tog_minus.gif)        Duplicating a window and it's tabs
...
![tog_minus](../images/tog_minus.gif)        Switching tabs
