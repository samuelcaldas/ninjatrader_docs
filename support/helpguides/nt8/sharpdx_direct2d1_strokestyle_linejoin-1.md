...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_direct2d1_strokestyle_linejoin.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1-1.htm) > [StrokeStyle](sharpdx_direct2d1_strokestyle-1.htm) >  SharpDX.Direct2D1.StrokeStyle.LineJoin | [Previous page](sharpdx_direct2d1_strokestyle_getdashes-1.htm) [Return to chapter overview](sharpdx_direct2d1_strokestyle-1.htm) [Next page](sharpdx_direct2d1_strokestyle_miterlimit-1.htm) |
