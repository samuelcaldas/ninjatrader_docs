...
> **Notes:**
- If you are looking to extend behavior of an Indicator or Strategy (e.g., values of one property influence another), you must implement either an [IndicatorBaseTypeConverter](../indicators/indicatorbaseconverter.md) or [StrategyBaseTypeConveter](../strategies/strategybaseconverter.md).  This is to ensure default property descriptor behavior works as intended.
