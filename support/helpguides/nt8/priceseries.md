...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](priceseries.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Common](common.htm) > [ISeries<T>](iseriest.htm) >  PriceSeries<double> | [Previous page](reset.htm) [Return to chapter overview](iseriest.htm) [Next page](close.htm) |
