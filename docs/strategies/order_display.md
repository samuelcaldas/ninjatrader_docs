...
Default color is spring green with text "MIT"

4) Stop-Market Order

Default color is pink with text "STP"

5) Simulated Stop Order

Default color is yellow with text "SLM" or "STP"

The image below shows a working limit, stop-market, and stop-limit order for one contract each.    SuperDOM_9
