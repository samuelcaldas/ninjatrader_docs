...
| Rithmic commissions) |  |  |  |  |  |  |  |  |  |  |
| TD Ameritrade commissions) |  |  |  |  |  |  |  | (NinjaTrader calculated) |  |  |
...
![tog_minus](../images/tog_minus.gif)Accounts tab properties
