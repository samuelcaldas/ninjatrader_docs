...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\collapsed_view.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Order Entry](order_entry-1.htm) > [Chart Trader](chart_trader-1.htm) >  Hidden View | [Previous page](order__position_display-1.htm) [Return to chapter overview](chart_trader-1.htm) [Next page](submitting_orders4-1.htm) |
...
There are two ways to collapse the Chart Trader panel. You can either click the Chart Trader icon on the chart toolbar, then select the "Chart Trader (Hidden)" menu item, as seen in the image below, or you can edit the "Chart Trader" property within the [chart Properties](chart_properties-1.htm) window. When you wish to view the Chart Trader panel once more, you can use the same methods to select the "Chart Trader" menu item.
