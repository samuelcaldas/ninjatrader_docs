...
Optionally add additional event methods to your custom script, such as [OnMarketData](../language_reference/onmarketdata.md), [OnMarketDepth](../language_reference/onmarketdepth.md), etc
