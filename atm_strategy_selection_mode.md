...
![tog_minus](tog_minus.gif)        Understanding the "Select Active ATM Strategy on Order Submission" mode
...
![tog_minus](tog_minus.gif)        Understanding the "Keep Selected ATM Strategy Template on Order Submission" mode
...
![tog_minus](tog_minus.gif)        Understanding the "Display Selected ATM Strategy Only" mode
