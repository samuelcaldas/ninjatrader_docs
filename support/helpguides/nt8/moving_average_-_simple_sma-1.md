...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\moving_average_-_simple_sma.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [System Indicator Methods](indicators-1.htm) >  Moving Average - Simple (SMA) | [Previous page](moving_average_-_mesa_adaptive-1.htm) [Return to chapter overview](indicators-1.htm) [Next page](moving_average_-_t3_t3-1.htm) |
