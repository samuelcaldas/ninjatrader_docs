...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\cs0019.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Editor](editor-1.htm) > [Compile Error Codes](compile_error_codes-1.htm) >  CS0019 | [Previous page](cs0006-1.htm) [Return to chapter overview](compile_error_codes-1.htm) [Next page](cs0021-1.htm) |
