...
- Session template will default to "<Use instrument settings>"  For Chart Styles, all parameters within the Chart Style section of the Data Series window will be saved.  |  
...
> Please see the [Working with Drawing Tools & Objects](../drawing_tools/working_with_drawing_tools__ob.md) page for more information on saving and managing drawing object templates.
