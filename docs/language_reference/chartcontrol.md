...
![ChartControl_1](../images/chartcontrol_1.png)
...
| [CrosshairType](crosshairtype.md) | Indicates the [Cross Hair](../operations/cross_hair.md) type currently enabled on the chart |
| [FirstTimePainted](firsttimepainted.md) | Indicates a time value of the first bar painted on the chart |
| [GetBarPaintWidth()](../drawing_tools/getbarpaintwidth.md) | Returns the width of the bars in the primary Bars object on the chart, in pixels |
...
| [Indicators](../indicators/chartcontrol_indicators.md) | Returns a collection of indicators currently configured on the chart |
...
| [IsStayInDrawMode](isstayindrawmode.md) | Indicates the [Stay in Draw Mode](../drawing_tools/working_with_drawing_tools__ob.md) is currently enabled on the chart |
