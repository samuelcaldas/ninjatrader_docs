...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\moving_average_-_hull_hma.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [System Indicator Methods](indicators-1.htm) >  Moving Average - Hull (HMA) | [Previous page](moving_average_-_exponential_e-1.htm) [Return to chapter overview](indicators-1.htm) [Next page](moving_average_-_kaufmans_adap-1.htm) |
