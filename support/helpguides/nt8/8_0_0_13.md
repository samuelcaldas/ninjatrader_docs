...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\8_0_0_13.htm) >>  **Navigation:**  [Release Notes](release_notes-1.htm) > [Beta](beta_release_notes.htm) >  8.0.0.13 (RC1) Release Notes | [Previous page](8_0_0_14.htm) [Return to chapter overview](beta_release_notes.htm) [Next page](8_0_0_12.htm) |
...
•The [Stroke](stroke_class-1.htm) object .Dispose() method was removed due to technical redundancy.  To remove memory resources from any stroke objects, simply set the stroke to null.

•Removed property Bars.IsTimebased -> please use [Bars.BarsType.IsTimeBased](barstype_istimebased-1.htm) instead

•Account.Accounts was renamed to [Account.All](all-1.htm)

Implementation changes

•The common signature "isInclude60" used in various [SessionIterator](sessioniterator-1.htm) methods was renamed to "includesEndTimeStamp" to be more specific

•Category display order values of standard NinjaTrader Property Grid Categories were updated to be more consistent application wide.  These changes could impact any customization you were doing using the [CategoryOrderAttribute](categoryorderattribute-1.htm), however, the documentation was also updated to reflect the implementation more accurately and will allow you to use this attribute reliably.

•To assist with transitioning historical order objects to real-time order references, please use the new [GetRealtimeOrder()](getrealtimeorder-1.htm) method.
