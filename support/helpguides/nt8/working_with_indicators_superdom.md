...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](working_with_indicators_superdom.htm) >>  **Navigation:**  [Operations](operations.htm) > [Order Entry](order_entry.htm) > [SuperDOM](superdom.htm) >  Working with Indicators | [Previous page](superdom_templates.htm) [Return to chapter overview](superdom.htm) [Next page](properties_superdom.htm) |
...
The SuperDOM's [Price Ladder display](price_ladder_display.htm) has the ability to add any number of price action indicators which can be used to visualize and analyze indicator values in relation to the SuperDOM display, as well as attaching working orders to the indicator price level for a hand-free trade management system.
...
![tog_minus](tog_minus.gif)        Understanding the Indicators window
...
![tog_minus](tog_minus.gif)        Understanding how indicators are displayed
