...
![[[tog_minus](../images/tog_minus.gif)        How to Create an Instrument List from the Market Analyzer

> Creating an Instrument List If you have a Market Analyzer setup with a number of different instruments you would like to save for later, you can quickly add the entire display of instruments into an [[[Instrument List](instrument_lists.md) for quick access.
...
![[[tog_minus](../images/tog_minus.gif)        How to add Label rows
...
![[[tog_minus](../images/tog_minus.gif)        How to add Blank rows
...
![[[tog_minus](../images/tog_minus.gif)        How to move Instrument, Label and Blank rows
...
![[[tog_minus](../images/tog_minus.gif)        How to remove Instrument, Label and Blank rows
...
![[[tog_minus](../images/tog_minus.gif)        How to add and remove a Total row
...
![[[tog_minus](../images/tog_minus.gif)        Understanding Row Filtering
