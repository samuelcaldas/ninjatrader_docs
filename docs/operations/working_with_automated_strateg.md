...
Automated NinjaScript strategies can be enabled within an open chart. Both real-time and historical strategy trades will be displayed on the chart. For more information on creating and managing NinjaScript strategies, see the [NinjaScript Overview](../ninjascript/ninjascript.md) page.

![tog_minus](../images/tog_minus.gif)

> Please see the [Running a NinjaScript Strategy From a Chart](../strategies/running_a_ninjascript_strategy.md) page for more information on applying and enabling strategies from charts, as well as more information on managing strategy properties.
...
![tog_minus](../images/tog_minus.gif)        Viewing strategy performance
...
![tog_minus](../images/tog_minus.gif)        Understanding strategy templates
