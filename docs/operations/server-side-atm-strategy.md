...
Replicated from the order entry display and sets the TIF used for entry, profit target, and stop loss orders.
...
Sets the quantity for the Stop Loss and Profit Target orders for this target
...
For further reference, please look at the [Server Side Strategy Examples](../strategies/tutorial-server-side-atm-examp.md) located within the "[Server Side ATM Strategy](server-side-atm-strategy.md)" page.