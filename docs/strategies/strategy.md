...
| [BarsRequiredToTrade](barsrequiredtotrade.md) | The number of historical bars required before the strategy starts processing order methods called in the [OnBarUpdate()](../language_reference/onbarupdate.md) method. |
...
| [ChartIndicators](../indicators/chartindicators.md) | Contains a collection of Indicators which have been added to the strategy instance using [AddChartIndicator()](../indicators/addchartindicator.md). |
...
| [StartBehavior](startbehavior.md) | Sets the start behavior of the strategy. See [Syncing Account Positions](../ninjascript/syncing_account_positions.md) for more information. |
