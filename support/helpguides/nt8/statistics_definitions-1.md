...
![tog_minus](tog_minus-1.gif)        Understanding Profit
...
![tog_minus](tog_minus-1.gif)        Understanding Total Net Profit
...
![tog_minus](tog_minus-1.gif)        Understanding Gross Profit
...
![tog_minus](tog_minus-1.gif)        Understanding Gross Loss
...
![tog_minus](tog_minus-1.gif)        Understanding Commission
...
![tog_minus](tog_minus-1.gif)        Understanding Profit Factor
...
![tog_minus](tog_minus-1.gif)        Understanding Max. Drawdown
...
![tog_minus](tog_minus-1.gif)        Understanding Sharpe Ratio
...
![tog_minus](tog_minus-1.gif)        Understanding Sortino Ratio
...
![tog_minus](tog_minus-1.gif)        Understanding Ulcer Index
...
![tog_minus](tog_minus-1.gif)        Understanding Probability
...
![tog_minus](tog_minus-1.gif)        Understanding Winning, Losing, Even, and Total Number of Trades
...
![tog_minus](tog_minus-1.gif)        Understanding Average Trade
...
![tog_minus](tog_minus-1.gif)        Understanding Average Winning Trade
...
![tog_minus](tog_minus-1.gif)        Understanding Average Losing Trade
...
![tog_minus](tog_minus-1.gif)        Understanding Ratio Avg Win / Avg Loss
...
![tog_minus](tog_minus-1.gif)        Understanding Maximum Consecutive Winners
...
![tog_minus](tog_minus-1.gif)        Understanding Maximum Consecutive Losers
...
![tog_minus](tog_minus-1.gif)        Understanding Average Time in Market
...
![tog_minus](tog_minus-1.gif)        Understanding Profit Per Month
...
![tog_minus](tog_minus-1.gif)        Understanding Max. Time to Recover
...
![tog_minus](tog_minus-1.gif)        Understanding Longest Flat Period
...
![tog_minus](tog_minus-1.gif)        Understanding Average MAE
...
![tog_minus](tog_minus-1.gif)        Understanding Average MFE
...
![tog_minus](tog_minus-1.gif)        Understanding Average ETD
...
![tog_minus](tog_minus-1.gif)        Understanding Cumulative Profit
...
![tog_minus](tog_minus-1.gif)        Understanding Entry, Exit, and Total Efficiency
