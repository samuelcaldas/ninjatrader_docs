...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](strategyanalyzer_properties.htm) >>  **Navigation:**  [Operations](operations.htm) > [Strategy Analyzer](strategy_analyzer.htm) >  Strategy Analyzer Properties | [Previous page](saving_strategy_parameter_temp.htm) [Return to chapter overview](strategy_analyzer.htm) [Next page](strategyanalyzer_properties_2.htm) |
