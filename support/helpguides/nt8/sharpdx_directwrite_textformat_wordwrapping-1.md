...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_directwrite_textformat_wordwrapping.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.DirectWrite](sharpdx_directwrite-1.htm) > [TextFormat](sharpdx_directwrite_textformat-1.htm) >  SharpDX.DirectWrite.TextFormat.WordWrapping | [Previous page](sharpdx_directwrite_textformat_textalignment-1.htm) [Return to chapter overview](sharpdx_directwrite_textformat-1.htm) [Next page](sharpdx_directwrite_linemetrics-1.htm) |
