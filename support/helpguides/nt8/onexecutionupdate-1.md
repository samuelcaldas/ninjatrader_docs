...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\onexecutionupdate.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Strategy](strategy-1.htm) >  OnExecutionUpdate() | [Previous page](accountitemeventargs-1.htm) [Return to chapter overview](strategy-1.htm) [Next page](onordertrace-1.htm) |
...
|  |  |
| --- | --- |
| execution | An [Execution](execution-1.htm) object passed by reference representing the execution |
...
| marketPosition | A [MarketPosition](position_marketposition-1.htm) object representing the position of the execution.  Possible values are:  •MarketPosition.Long  •MarketPosition.Short |
