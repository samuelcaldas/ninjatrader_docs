...
![tog_minus](../images/tog_minus.gif)        Saving a workspace
...
![tog_minus](../images/tog_minus.gif)        Opening a workspace
...
![tog_minus](../images/tog_minus.gif)        Closing a workspace
...
![tog_minus](../images/tog_minus.gif)        How to quickly switch between workspaces

> Quickly Switching Between Workspaces Pressing SHIFT+F3 keys together will cycle to the next open workspace.

![tog_minus](../images/tog_minus.gif)        How to recover workspaces
