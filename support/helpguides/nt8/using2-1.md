...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\using2.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Developing Indicators](developing_indicators-1.htm) > [Beginner - Indicator on Indicator](beginner_-_indicator_on_indica-1.htm) >  Using | [Previous page](compiling2-1.htm) [Return to chapter overview](beginner_-_indicator_on_indica-1.htm) [Next page](beginner_-_using_price_variabl-1.htm) |
