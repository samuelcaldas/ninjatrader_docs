...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](creating_a_market_analyzer_win.htm) >>  **Navigation:**  [Operations](operations.htm) > [Market Analyzer](market_analyzer.htm) >  Creating a Market Analyzer Window | [Previous page](market_analyzer.htm) [Return to chapter overview](market_analyzer.htm) [Next page](working_with_instrument_rows.htm) |
