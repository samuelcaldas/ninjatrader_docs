...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\chartscale_properties.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [Charts](chart-1.htm) > [ChartScale](chartscale-1.htm) >  Properties | [Previous page](panelindex-1.htm) [Return to chapter overview](chartscale-1.htm) [Next page](chartscale_scalejustification-1.htm) |
