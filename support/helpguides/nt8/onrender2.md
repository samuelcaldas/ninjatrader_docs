...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](onrender2.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Market Analyzer Column](market_analyzer_column.htm) >  OnRender() | [Previous page](iseditable.htm) [Return to chapter overview](market_analyzer_column.htm) [Next page](priorvalue.htm) |
