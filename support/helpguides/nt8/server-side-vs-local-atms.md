...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](server-side-vs-local-atms.htm) >>  **Navigation:**  [Operations](operations.htm) > [Advanced Trade Management (ATM)](advanced_trade_management_atm.htm) >  Server Side vs Local ATMs | [Previous page](advanced_trade_management_atm.htm) [Return to chapter overview](advanced_trade_management_atm.htm) [Next page](atm_strategy.htm) |
...
![tog_minus](tog_minus.gif)        Manually canceling a stop/target
...
![tog_minus](tog_minus.gif)        Visibility and modification of stop losses/profits of ATM entry orders
...
![tog_minus](tog_minus.gif)        Parameter Type functionality
...
![tog_minus](tog_minus.gif)        Miscellaneous differences
