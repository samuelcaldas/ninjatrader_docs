...
![tog_minus](tog_minus.gif)        How to make price data comparisons
...
![tog_minus](tog_minus.gif)        How to use user inputs & variables
...
![tog_minus](tog_minus.gif)        How to use indicator inputs in other indicators
...
![tog_minus](tog_minus.gif)        How to check for volume expansion
...
![tog_minus](tog_minus.gif)        How to create market position comparisons
...
![tog_minus](tog_minus.gif)        How to negate a condition
...
![tog_minus](tog_minus.gif)        How to create time filters
