...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_lineargradientbrush_startpoint.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) > [LinearGradientBrush](sharpdx_direct2d1_lineargradientbrush.htm) >  SharpDX.Direct2D1.LinearGradientBrush.StartPoint | [Previous page](sharpdx_direct2d1_lineargradientbrush_gradientstopcollection.htm) [Return to chapter overview](sharpdx_direct2d1_lineargradientbrush.htm) [Next page](sharpdx_direct2d1_lineargradientbrushproperties.htm) |
