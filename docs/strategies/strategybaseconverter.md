...
- For Indicators, see the [IndicatorBaseConverter](../indicators/indicatorbaseconverter.md) class
...
> **Tip:** Common strategy functions like Print() are not available to a type converter instance.  To debug a type converter class, you can use the AddOn [Debug Concepts](../addons/alert_and_debug_concepts.md) or [attach to a debugger](../ninjascript/visual_studio_debugging.md) (recommended)
...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    public class MyCustomConveter : StrategyBaseConverter
    {
        ...
        // Important:
        This must return true otherwise the type converter will not be called
