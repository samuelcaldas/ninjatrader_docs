...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](cs0021.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Editor](editor.htm) > [Compile Error Codes](compile_error_codes.htm) >  CS0021 | [Previous page](cs0019.htm) [Return to chapter overview](compile_error_codes.htm) [Next page](cs0029.htm) |
