...
![tog_minus](tog_minus-1.gif)        Creating a new connection
...
![tog_minus](tog_minus-1.gif)        Connecting to a connection
...
![tog_minus](tog_minus-1.gif)        Disconnecting from a connection
...
![tog_minus](tog_minus-1.gif)        Understanding the Pre-Built Connections
