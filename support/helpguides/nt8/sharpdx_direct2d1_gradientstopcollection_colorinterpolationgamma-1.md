...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_direct2d1_gradientstopcollection_colorinterpolationgamma.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1-1.htm) > [GradientStopCollection](sharpdx_direct2d1_gradientstopcollection-1.htm) >  SharpDX.Direct2D1.GradientStopCollection.ColorInterpolationGamma | [Previous page](sharpdx_direct2d1_gradientstopcollection-1.htm) [Return to chapter overview](sharpdx_direct2d1_gradientstopcollection-1.htm) [Next page](sharpdx_direct2d1_gradientstopcollection_extendmode-1.htm) |
