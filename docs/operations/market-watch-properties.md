...
The following properties are available for configuration within the Market Watch Properties window:    MarketWatchProperties   Property Definitions
...
Select the size used for all tiles in the Market Watch display

Colors

Up area

Sets the area color for prices above last close

Down area

Sets the area color for prices below last close
...
Sets the outline color for prices above last close

Down outline

Sets the outline color for prices below last close
...
![Marketwatchproperties](../images/marketwatchproperties.png)