...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](seriest.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Common](common.htm) > [ISeries<T>](iseriest.htm) >  Series<T> | [Previous page](iseriest.htm) [Return to chapter overview](iseriest.htm) [Next page](reset.htm) |
