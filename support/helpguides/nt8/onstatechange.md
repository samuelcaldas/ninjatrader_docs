...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](onstatechange.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Common](common.htm) >  OnStateChange() | [Previous page](marketdeptheventargs.htm) [Return to chapter overview](common.htm) [Next page](setstate.htm) |
