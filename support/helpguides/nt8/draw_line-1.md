...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\draw_line.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [Drawing](drawing-1.htm) >  Draw.Line() | [Previous page](horizontalline-1.htm) [Return to chapter overview](drawing-1.htm) [Next page](line-1.htm) |
...
A [Line](line-1.htm) object that represents the draw object.
