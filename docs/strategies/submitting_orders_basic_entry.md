...
Quick Buttons You can enter orders rapidly by pressing on any one of the quick order buttons.    BasicEntry_12
...
Submits a Sell Limit order at the current ask price
...
Submits a Buy Limit order at the current bid price

Sell Bid

Submits a Sell Limit order at the current bid price
