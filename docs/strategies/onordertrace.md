...
> **Warning:** Overriding this method with disable the default order tracing that is generated by the NinjaTrader core.  It is then up to you to pass the message generated to the NinjaTrader [output window](../ninjascript/output.md) using the [Print()](../language_reference/print.md) method.  Generally, overriding this method is not required.
