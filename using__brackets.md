...
```csharp
double SMA\_current = SMA(14)[0]; // gets the current value of the SMA
double SMA\_1 = SMA(14)[1]; // gets the SMA value one bar ago
double SMA\_value = SMA(14); // results in compile error. SMA(14) is a Series and the variable SMA\_value of type double can't hold a Series.
```
