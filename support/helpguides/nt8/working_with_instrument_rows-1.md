...
![tog_minus](tog_minus-1.gif)        How to add instruments
...
![tog_minus](tog_minus-1.gif)        How to Create an Instrument List from the Market Analyzer
...
![tog_minus](tog_minus-1.gif)        How to add Label rows
...
![tog_minus](tog_minus-1.gif)        How to add Blank rows
...
![tog_minus](tog_minus-1.gif)        How to move Instrument, Label and Blank rows
...
![tog_minus](tog_minus-1.gif)        How to remove Instrument, Label and Blank rows
...
![tog_minus](tog_minus-1.gif)        How to add and remove a Total row
...
![tog_minus](tog_minus-1.gif)        Understanding Row Filtering
