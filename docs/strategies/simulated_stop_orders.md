...
![tog_minus](../images/tog_minus.gif)        Simulated Stop examples
...
![tog_minus](../images/tog_minus.gif)        Understanding when to avoid using Simulated Stop orders
