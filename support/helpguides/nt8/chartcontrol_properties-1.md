...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\chartcontrol_properties.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [Charts](chart-1.htm) > [ChartControl](chartcontrol-1.htm) >  Properties | [Previous page](presentationsource-1.htm) [Return to chapter overview](chartcontrol-1.htm) [Next page](slotspainted-1.htm) |
