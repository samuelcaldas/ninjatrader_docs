...
| EndAnchor | An [IDrawingTool's ChartAnchor](idrawingtool-1.md#chartanchor) representing the end point of the drawing object |
| ExtensionAnchor | An [IDrawingTool's ChartAnchor](idrawingtool-1.md#chartanchor) representing the extension point of the drawing object |
