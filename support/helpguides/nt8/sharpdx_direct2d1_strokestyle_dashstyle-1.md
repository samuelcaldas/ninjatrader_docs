...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_direct2d1_strokestyle_dashstyle.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1-1.htm) > [StrokeStyle](sharpdx_direct2d1_strokestyle-1.htm) >  SharpDX.Direct2D1.StrokeStyle.DashStyle | [Previous page](sharpdx_direct2d1_strokestyle_dashoffset-1.htm) [Return to chapter overview](sharpdx_direct2d1_strokestyle-1.htm) [Next page](sharpdx_direct2d1_strokestyle_endcap-1.htm) |
...
|  |
| --- |
| Note: If a custom dash style is specified, the dash pattern is described by the dashes array, which can be retrieved by calling the [GetDashes()](sharpdx_direct2d1_strokestyle_getdashes-1.htm) method. |
