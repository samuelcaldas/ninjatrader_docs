...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](order_display.htm) >>  **Navigation:**  [Operations](operations.htm) > [Order Entry](order_entry.htm) > [SuperDOM](superdom.htm) >  Order Display | [Previous page](static_vs_dynamic_price_ladder.htm) [Return to chapter overview](superdom.htm) [Next page](submitting_orders_superdom.htm) |
...
![tog_minus](tog_minus.gif)        Understanding how the quantity of an order are displayed
...
![tog_minus](tog_minus.gif)        Understanding how multiple orders at the same price are displayed
...
![tog_minus](tog_minus.gif)        Understanding how Stop Loss and Profit Target orders are displayed
