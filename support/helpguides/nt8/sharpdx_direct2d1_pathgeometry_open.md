...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_pathgeometry_open.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) > [PathGeometry](sharpdx_direct2d1_pathgeometry.htm) >  SharpDX.Direct2D1.PathGeometry.Open() | [Previous page](sharpdx_direct2d1_pathgeometry_getbounds.htm) [Return to chapter overview](sharpdx_direct2d1_pathgeometry.htm) [Next page](sharpdx_direct2d1_pathgeometry_segmentcount.htm) |
