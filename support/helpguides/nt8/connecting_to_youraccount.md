...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\connecting_to_youraccount.htm) >>  **Navigation:**  [Configuration](configuration-1.htm) > [Connecting](connecting-1.htm) >  Connecting to your Account | [Previous page](connecting-1.htm) [Return to chapter overview](connecting-1.htm) [Next page](connecting_to_kinetick-1.htm) |
