...
Order Display A resting order is displayed on the chart as a color-coded line connecting an order price label in the right margin of the chart with a second label displaying the order quantity and type.
...
Market orders are not displayed (see Control Center [Orders Tab](orders_tab.md) for more information)

Market if Touched (MIT) Order

Default color is spring green with the text "MIT"
...
Chart trader color properties can be set via the Chart Trader [properties window](properties3.md).    The image below displays how orders are visualized in a NinjaTrader chart with Chart Trader enabled.    ChartTrader1    1. Buy stop-limit order for 1 contract at a price of X  2. Buy stop-market order for 1 contract at a price of X  3. Buy limit order for 1 contract at a price of X
...
![Charttrader2](../images/charttrader2.png)
