...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_size2f.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX](sharpdx.htm) >  SharpDX.Size2F | [Previous page](sharpdx_rectanglef.htm) [Return to chapter overview](sharpdx.htm) [Next page](sharpdx_vector2.htm) |
