...
| RenderTarget | The [RenderTarget](../language_reference/rendertarget.md) drawing context used for the line.    Note: This property must be set before accessing a stroke's BrushDX property. Please see Warning and examples remarked below |
