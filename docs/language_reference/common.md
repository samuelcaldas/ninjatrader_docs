...
| [[[Drawing](drawing.md) | Documents the drawing of custom shapes, lines, text and colors on your price and indicator panels from both [[[Indicators](../indicators/indicator.md) and [[[Strategies](../strategies/strategy.md) |
...
| [[[System Indicator Methods](../indicators/indicators.md) | Documents syntax and return values for system indicator methods |
