...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\cs1503.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Editor](editor-1.htm) > [Compile Error Codes](compile_error_codes-1.htm) >  CS1503 | [Previous page](cs1502-1.htm) [Return to chapter overview](compile_error_codes-1.htm) [Next page](cs1513-1.htm) |
...
This error can occur when you try to assign a value to a [Series<T>](seriest-1.htm) that is not of the correct value type.
