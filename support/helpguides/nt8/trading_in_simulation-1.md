...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\trading_in_simulation.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Simulator](simulation-1.htm) >  Trading in Simulation | [Previous page](global_simulation_mode-1.htm) [Return to chapter overview](simulation-1.htm) [Next page](strategy_analyzer-1.htm) |
