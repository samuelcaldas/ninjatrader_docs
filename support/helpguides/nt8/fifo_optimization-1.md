...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\fifo_optimization.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Order Entry](order_entry-1.htm) >  FIFO Optimization | [Previous page](order_state_definitions-1.htm) [Return to chapter overview](order_entry-1.htm) [Next page](working_with_forex-1.htm) |

All of the NinjaTrader order entry interfaces preserve FIFO (First In First Out) status with the exchanges when possible.

![tog_minus](tog_minus-1.gif)        Why is FIFO important?
...
![tog_minus](tog_minus-1.gif)        How does NinjaTrader preserve FIFO?
