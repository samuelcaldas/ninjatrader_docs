...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](output.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Editor](editor.htm) >  Output Window | [Previous page](intelliprompt.htm) [Return to chapter overview](editor.htm) [Next page](visual_studio_debugging.htm) |
...
![tog_minus](tog_minus.gif)        Searching and highlighting
...
![tog_minus](tog_minus.gif)        NinjaScript Utilization Monitor
