...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](how_bars_are_built.htm) >>  **Navigation:**  [Operations](operations.htm) > [Charts](charts.htm) >  How Bars are Built | [Previous page](reload_historical_data.htm) [Return to chapter overview](charts.htm) [Next page](how_trade_executions_are_plott.htm) |
