...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\compiling3.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Developing Indicators](developing_indicators-1.htm) > [Intermediate - Your own SMA](intermediate_-_your_own_sma-1.htm) >  Compiling | [Previous page](entering_calculation_logic3-1.htm) [Return to chapter overview](intermediate_-_your_own_sma-1.htm) [Next page](using3-1.htm) |
