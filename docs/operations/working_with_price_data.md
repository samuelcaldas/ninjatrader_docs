...
Type the instrument symbol (Add the contract month for futures instruments). Examples: "ES ##-##" for E-mini S&P 500, "AAPL" for Apple stock, or "EURUSD" for Euro/USD forex pair.
...
![Pricedata4](../images/pricedata4.png)
...
To change instrument and interval

Type the symbol and interval together. For example, typing "AAPL 5M" will change to a 5 minute chart of Apple stock.

To add additional series of primary instrument

Type a plus sign (+) plus the interval. For example, typing "+5M" will add a 5 minute Data Series of the primary instrument.

To add additional series of any instrument

Type a plus sign (+) plus the instrument and interval. For example, typing "+AAPL 5M" will add a 5 minute series of Apple stock. If no interval is provided, then the same interval as the primary series will be added.

![Pricedata7](../images/pricedata7.png)

![Pricedata5](../images/pricedata5.png)
...
![Pricedata6](../images/pricedata6.png)
