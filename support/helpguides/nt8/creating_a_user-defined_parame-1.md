...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\creating_a_user-defined_parame.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Reference Samples](reference_samples-1.htm) > [Indicator](indicator2-1.htm) >  Creating a user-defined parameter type (enum) | [Previous page](coloring_a_region-1.htm) [Return to chapter overview](indicator2-1.htm) [Next page](creating_your_own_level_ii_dat-1.htm) |
