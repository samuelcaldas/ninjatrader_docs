...
Displays the time stamp of the trade, The time stamp format can be configured via the [Time & Sales properties](timeandsales_properties.md) dialog window
...
Displays a 'B' if the last trade size was greater then the "Block alert trade size" configured via the [Time & Sales properties](timeandsales_properties.md) dialog window
