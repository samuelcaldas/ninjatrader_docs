...
The current order state. See the [Order State Definitions](order_state_definitions.md) page for a complete list of possible states and their definitions.
