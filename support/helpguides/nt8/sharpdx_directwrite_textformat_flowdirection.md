...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_directwrite_textformat_flowdirection.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.DirectWrite](sharpdx_directwrite.htm) > [TextFormat](sharpdx_directwrite_textformat.htm) >  SharpDX.DirectWrite.TextFormat.FlowDirection | [Previous page](sharpdx_directwrite_textformat.htm) [Return to chapter overview](sharpdx_directwrite_textformat.htm) [Next page](sharpdx_directwrite_textformat_fontfamilyname.htm) |
