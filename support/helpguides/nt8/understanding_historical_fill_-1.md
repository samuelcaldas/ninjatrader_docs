...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\understanding_historical_fill_.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Strategy Analyzer](strategy_analyzer-1.htm) >  Understanding Historical Fill Processing | [Previous page](ai-generate-1.htm) [Return to chapter overview](strategy_analyzer-1.htm) [Next page](basket_test-1.htm) |
...
![tog_minus](tog_minus-1.gif)        Understanding the Historical Fill Algorithm
