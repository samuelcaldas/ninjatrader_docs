...
PriceLevel.GetPrice():  Removed redundant [[[chartScale overload](../language_reference/pricelevels.md)
...
You can read more about the NinjaScript Folders in the "Managing scripts and folders" section of the [[[NinjaScript Explorer](../ninjascript/ns_explorer.md) help guide article.
