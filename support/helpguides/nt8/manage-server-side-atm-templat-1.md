...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\manage-server-side-atm-templat.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Advanced Trade Management (ATM)](advanced_trade_management_atm-1.htm) > [Server Side ATMs](server-side-atm-strategy-1.htm) >  Manage Server Side ATM Templates | [Previous page](server-side-stop-strategy-1.htm) [Return to chapter overview](server-side-atm-strategy-1.htm) [Next page](auto_close_position-1.htm) |
