...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_geometrysink.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) >  SharpDX.Direct2D1.GeometrySink | [Previous page](sharpdx_direct2d1_fillmode.htm) [Return to chapter overview](sharpdx_direct2d1.htm) [Next page](sharpdx_direct2d1_geometrysink_addarc.htm) |
