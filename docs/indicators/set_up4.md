...
1. Within the NinjaTrader [Control Center](../operations/control_center.md), select the New menu, then select the NinjaScript Editor menu item.
...
![PriceVariableTutorialSetUp1](../images/pricevariabletutorialsetup1.png)
...
![NSTutorialSetUpNoOverlayOnPrice](../images/nstutorialsetupnooverlayonprice.png)

## Adding Additional Data

The next page will allow you to configure one or more additional [Bars](../language_reference/bars.md) objects for use by the indicator. For our purposes, we will leave this page blank and move forward by clicking the Next > button.

![NSTutAdditionalDataBlank](../images/nstutadditionaldatablank.png)
...
![NSTutAdditionalEventMethodsBlank](../images/nstutadditionaleventmethodsblank.png)
...
![PriceVariableTutorialSetUp4](../images/pricevariabletutorialsetup4.png)
...
![NSTutAddPlotMyPlot](../images/nstutaddplotmyplot.png)
