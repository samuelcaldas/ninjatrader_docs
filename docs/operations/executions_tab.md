...
Indicates whether the execution was from a Buy or Sell order
...
Indicates whether the execution was an Entry or Exit

Position

Indicates the Account Position after the execution

Order ID

The ID of the order executed

Name

The name of the order executed

Commission

The commission applied to the execution

Rate

The currency conversion rate used for the execution. A value of "1" indicates that no currency conversion took place

Account Display Name

The Display Name of the account to which the execution was placed

Connection

The connection through which the execution was routed
...
Configure the executions tab properties
