...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](manage_atm_strategy_templates.htm) >>  **Navigation:**  [Operations](operations.htm) > [Advanced Trade Management (ATM)](advanced_trade_management_atm.htm) > [ATM Strategy](atm_strategy.htm) >  Manage ATM Strategy Templates | [Previous page](auto_trail.htm) [Return to chapter overview](atm_strategy.htm) [Next page](tutorial_atm_strategy_example_.htm) |
...
See [ATM Strategy Example #1](tutorial_atm_strategy_example_.htm) and [ATM Strategy Example #2](tutorial_atm_strategy_example2.htm) for further reference on how to create and save an ATM Strategy template.