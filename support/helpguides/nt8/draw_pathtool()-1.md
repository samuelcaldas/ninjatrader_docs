...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\draw_pathtool().htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [Drawing](drawing-1.htm) >  Draw.PathTool() | [Previous page](line-1.htm) [Return to chapter overview](drawing-1.htm) [Next page](pathtool-1.htm) |
...
A [PathTool](pathtool-1.htm) object that represents the draw object.
