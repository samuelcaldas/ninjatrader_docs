...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_rectanglef.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX](sharpdx-1.htm) >  SharpDX.RectangleF | [Previous page](sharpdx_matrix3x2-1.htm) [Return to chapter overview](sharpdx-1.htm) [Next page](sharpdx_size2f-1.htm) |
