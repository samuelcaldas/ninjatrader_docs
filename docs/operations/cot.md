...
![Cot3](../images/cot3.png)

 |

## COT Values NinjaScript access

> For information on how to access the COT values in NinjaScript, please see the [Commitment Of Traders (COT)](../indicators/commitment_of_traders_cot.md).md) page in the NinjaScript section of the Help Guide.

![Cot4](../images/cot4.png)