...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\server-side-vs-local-atms.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Advanced Trade Management (ATM)](advanced_trade_management_atm-1.htm) >  Server Side vs Local ATMs | [Previous page](advanced_trade_management_atm-1.htm) [Return to chapter overview](advanced_trade_management_atm-1.htm) [Next page](atm_strategy-1.htm) |
...
![tog_minus](tog_minus-1.gif)        Manually canceling a stop/target
...
![tog_minus](tog_minus-1.gif)        Visibility and modification of stop losses/profits of ATM entry orders
...
![tog_minus](tog_minus-1.gif)        Parameter Type functionality
...
![tog_minus](tog_minus-1.gif)        Miscellaneous differences
