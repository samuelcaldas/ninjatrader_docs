...
![tog_minus](../images/tog_minus.gif)        Understanding the Columns window
...
![tog_minus](../images/tog_minus.gif)        How to add columns
...
![tog_minus](../images/tog_minus.gif)        How to edit a column's parameters
...
![tog_minus](../images/tog_minus.gif)        Understanding the Notes Column
...
![tog_minus](../images/tog_minus.gif)        Understanding the Pulling/Stacking Column
...
![tog_minus](../images/tog_minus.gif)        Understanding the Recent Bid/Ask Column
...
![tog_minus](../images/tog_minus.gif)        Understanding the PnL Column
...
![tog_minus](../images/tog_minus.gif)        Understanding the Volume Column
...
![tog_minus](../images/tog_minus.gif)        How to remove columns
...
![tog_minus](../images/tog_minus.gif)        Customize the display of columns
...
![tog_minus](../images/tog_minus.gif)        Custom column development
