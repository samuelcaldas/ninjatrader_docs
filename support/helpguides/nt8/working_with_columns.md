...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](working_with_columns.htm) >>  **Navigation:**  [Operations](operations.htm) > [Market Analyzer](market_analyzer.htm) >  Working with Columns | [Previous page](working_with_instrument_rows.htm) [Return to chapter overview](market_analyzer.htm) [Next page](dynamic_ranking_and_sorting.htm) |
...
![tog_minus](tog_minus.gif)        Dynamic ranking and sorting

|  |
| --- |
| See the [Dynamic Ranking and Sorting](dynamic_ranking_and_sorting.htm) section of the user help guide for information on sorting and raking your Market Analyzer columns. |