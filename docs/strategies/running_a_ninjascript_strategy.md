...
- On terminating a strategy, all strategy generated trade markers or [draw objects](../drawing_tools/drawing_tools.md) will be removed from the chart
...
- "Strategy" - Uses the order size specified programmatically within the strategy | | Time in force | Sets the order's time in force. Possible values are DAY and GTC | |
