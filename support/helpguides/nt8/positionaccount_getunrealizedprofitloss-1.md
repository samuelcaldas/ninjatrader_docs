...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\positionaccount_getunrealizedprofitloss.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Strategy](strategy-1.htm) > [PositionAccount](positionaccount-1.htm) >  GetUnrealizedProfitLoss() | [Previous page](positionaccount_averageprice-1.htm) [Return to chapter overview](positionaccount-1.htm) [Next page](positionaccount_instrument-1.htm) |
