...
|  |
| --- |
| OnStateChange()  {  State.Configure)  {  // Add a 1 minute Point-and-Figure Bars object for the ES 03-18 contract - BarsInProgress index = 1   MarketDataType.Last);  }  }         {   // Ignore the primary Bars object and only process the Point-and-Figure Bars object   )  {  // Do something;  }  } |