...
|  |  |
| --- | --- |
| TrendStartAnchor | An [IDrawingTool's ChartAnchor](idrawingtool-1.md#chartanchor) representing the starting point of the drawing object |
| TrendEndAnchor | An [IDrawingTool's ChartAnchor](idrawingtool-1.md#chartanchor) representing the end point of the drawing object |
| ParallelStartAnchor | An [IDrawingTool's ChartAnchor](idrawingtool-1.md#chartanchor) representing the starting point of the second line used in the trend channel |
