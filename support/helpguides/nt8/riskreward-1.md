...
|  |  |
| --- | --- |
| EntryAnchor | An [IDrawingTool's ChartAnchor](idrawingtool-1.md#chartanchor) representing the entry point of the drawing object |
| RiskAnchor | An [IDrawingTool's ChartAnchor](idrawingtool-1.md#chartanchor) representing the stop loss point of the drawing object |
| RewardAnchor | An [IDrawingTool's ChartAnchor](idrawingtool-1.md#chartanchor) representing the profit target point of the drawing object |
