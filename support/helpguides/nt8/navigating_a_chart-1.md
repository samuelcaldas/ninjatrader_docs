...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\navigating_a_chart.md) >>  **Navigation:**  [Operations](operations-1.md) > [Charts](charts-1.md) >  Navigating a Chart | [Previous page](creating_a_chart-1.md) [Return to chapter overview](charts-1.md) [Next page](chart_panels-1.md) |
...
![tog_minus](tog_minus-1.gif)        How to change the horizontal scale and time range of a chart
...
![tog_minus](tog_minus-1.gif)        How to change the vertical scale and price range of a chart
...
![tog_minus](tog_minus-1.gif)        How to scroll a chart (panning)
...
![tog_minus](tog_minus-1.gif)        How to go to a specific time on the chart
...
![tog_minus](tog_minus-1.gif)        How to zoom in and out in a chart
...
![tog_minus](tog_minus-1.gif)        How to change the bar spacing and width
...
![tog_minus](tog_minus-1.gif)        How to change the cursor type
