...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\onpositionupdate.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Strategy](strategy-1.htm) >  OnPositionUpdate() | [Previous page](onorderupdate-1.htm) [Return to chapter overview](strategy-1.htm) [Next page](optimizationperiod-1.htm) |
...
|  |  |
| --- | --- |
| position | A [Position](position-1.htm) object passed by reference representing the current position object |
