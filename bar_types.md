...
- When backtesting different Bar Types (most notably Point and Figure and Renko) the backtest can yield different results than what you would experience in real-time, due to the nature of how the bars are constructed and the possibility of not having enough granular information to simulate what would have happened in real-time. Please see the [Discrepancies: Real-time vs Backtest](discrepancies_real-time_vs_bac.md) page for more information.
- When working with [TickReplay](tick_replay.md), the bars will be built from tick data available through the provider or local repository. For developing NinjaScript objects taking advantage of this option, please see [this link](developing_for__tick_replay.md).
...
![tog_minus](tog_minus.gif)        Understanding Range bars
...
![tog_minus](tog_minus.gif)        Understanding Time based bars
...
![tog_minus](tog_minus.gif)        Understanding Heiken Ashi bars
...
![tog_minus](tog_minus.gif)        Understanding Kagi bars
...
![tog_minus](tog_minus.gif)        Understanding Renko bars
...
![tog_minus](tog_minus.gif)        Understanding Point and Figure bars
...
![tog_minus](tog_minus.gif)        Understanding Line Break bars
...
![tog_minus](tog_minus.gif)        Understanding Order Flow Volumetric Bars
...
![tog_minus](tog_minus.gif)        Understanding Order Delta Bars

> For information on how to work with the Order Flow Delta Bars, please see the [Order Flow Delta Bars](order_flow_volumetric_bars.md) page in the [OrderFlow +](order_flow_plus.md) section of the Help Guide.
