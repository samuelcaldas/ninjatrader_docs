...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_strokestyleproperties.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) >  SharpDX.Direct2D1.StrokeStyleProperties | [Previous page](sharpdx_direct2d1_strokestyle_startcap.htm) [Return to chapter overview](sharpdx_direct2d1.htm) [Next page](sharpdx_direct2d1_sweepdirection.htm) |
