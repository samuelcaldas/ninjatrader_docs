...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\set_up4.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Developing Indicators](developing_indicators-1.htm) > [Beginner - Using price variables](beginner_-_using_price_variabl-1.htm) >  Set Up | [Previous page](beginner_-_using_price_variabl-1.htm) [Return to chapter overview](beginner_-_using_price_variabl-1.htm) [Next page](entering_calculation_logic-1.htm) |
...
After this, click the Finish button, and the Indicator Wizard will generate a basic code structure implementing the parameters that you have set. You are now ready to move on to [entering calculation logic](entering_calculation_logic-1.htm) in your code.