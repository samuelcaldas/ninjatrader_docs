...
The following properties are available for configuration within the Order Ticket Properties window:    OrderTicket_7   Property Definitions
...
Enables/Disables the feature which closes the current tab after an order is submitted

Show net change in pips for forex

Enables/Disables forex daily net change to reflect pips.  Otherwise, uses points
