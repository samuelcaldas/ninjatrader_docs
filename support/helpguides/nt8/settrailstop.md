...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](settrailstop.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Strategy](strategy.htm) > [Order Methods](order_methods.htm) > [Managed Approach](managed_approach.htm) >  SetTrailStop() | [Previous page](setstoploss.htm) [Return to chapter overview](managed_approach.htm) [Next page](unmanaged_approach.htm) |
