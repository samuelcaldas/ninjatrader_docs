...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\stopping_a_strategy_after_cons.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Reference Samples](reference_samples-1.htm) > [Strategy](strategy2-1.htm) >  Stopping a strategy after consecutive losers | [Previous page](separating_logic_to_either_cal-1.htm) [Return to chapter overview](strategy2-1.htm) [Next page](trading_crossovers-1.htm) |
