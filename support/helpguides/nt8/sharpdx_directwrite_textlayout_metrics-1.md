...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_directwrite_textlayout_metrics.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.DirectWrite](sharpdx_directwrite-1.htm) > [TextLayout](sharpdx_directwrite_textlayout-1.htm) >  SharpDX.DirectWrite.TextLayout.Metrics | [Previous page](sharpdx_directwrite_textlayout_maxwidth-1.htm) [Return to chapter overview](sharpdx_directwrite_textlayout-1.htm) |
