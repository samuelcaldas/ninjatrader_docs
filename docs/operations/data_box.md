...
End-of-bar time stamp corresponding to the location of your cursor

Price Data

Open, High, Low, and Close values for the bar
...
Values for indicators contained in the specific chart panel in which you view the Mini Data Box. Indicators will be displayed in the same order in which they were added in the [Indicators](../indicators/working_with_indicators.md) window.
...
![Minidatabox](../images/minidatabox.png)
