...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](indicators.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Common](common.htm) >  System Indicator Methods | [Previous page](simplefont_todirectwritetextformat.htm) [Return to chapter overview](common.htm) [Next page](valid_input_data_for_indicator.htm) |
