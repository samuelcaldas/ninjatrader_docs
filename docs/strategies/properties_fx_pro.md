...
The following properties are available for configuration within the FX Pro Properties window:    FXPro_22   Property Definitions
...
Sets the number of rows shown in the Level II display panel
...
Enables / Disables the Levell II display panel
...
Sets the color used for each individual price color (rows 1 through 10)
