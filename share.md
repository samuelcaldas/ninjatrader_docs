...
- args[1] = A string representing the email "Subject" field    ▪StockTwits share service:
...
Share("Gmail", "Test Message", new object[]{ "[[email protected]](/cdn-cgi/l/email-protection)", "Test Subject Line" });
```
