...
| [Order Ticket](../strategies/order_ticket.md) | Creates a new Order Ticket window |
| [SuperDOM](../strategies/superdom.md) (Dynamic) | Creates a new SuperDOM (Dynamic) window |
| [SuperDOM](../strategies/superdom.md) (Static) | Creates a new SuperDOM (Static) window |
| [Alerts Log](alerts_log.md) | Creates a new Alerts Log window |
| [Chart](charts.md) | Creates a new Chart window |
| [FX Board](../strategies/fx_board.md) | Creates a new FX Board window |
...
| [Strategy Analyzer](../strategies/strategy_analyzer.md) | Creates a new Strategy Analyzer window |
...
| [NinjaScript Editor](../ninjascript/editor.md) | Creates a new NinjaScript Editor window |
| [NinjaScript Output](../ninjascript/output.md) | Opens the NinjaScript output window (this includes the NinjaScript Utilization Monitor subwindow) |
| [Strategy Builder](../strategies/strategy_builder.md) | Creates a new Strategy Builder window |
| [AddOn Framework](../ninjascript/addon_development_overview.md) | This is an example for a custom NinjaScript AddOn installed |