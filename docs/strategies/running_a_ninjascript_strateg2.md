...
You can run a NinjaScript strategy in real-time in a live or simulation account via the [Strategies](../getting_started/options_strategies.md) tab of the Control Center.
...
Sets the Trading Hours template for the Data Series. (See the "[Trading Hours](../language_reference/sessioniterator.md)" section of the Help Guide for more information)

Break at EOD

Enables or disables the bars being reset at EOD (End Of Day). (See the "[Break at EOD](../operations/break_at_eod.md)" section of the Help Guide for more information)
...
![Running Ns 1](../images/running_ns_1.png)