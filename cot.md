...
![tog_minus](tog_minus.gif)        COT Parameters
...
![tog_minus](tog_minus.gif)        COT Values NinjaScript access

> For information on how to access the COT values in NinjaScript, please see the [Commitment Of Traders (COT)](commitment_of_traders_cot.md).md) page in the NinjaScript section of the Help Guide.
