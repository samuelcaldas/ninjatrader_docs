...
For more information on using images to create icons, see the [[[Using Images with Custom Icons](../ninjascript/using_images_and_geometry_with_custom_icons.md) page.
