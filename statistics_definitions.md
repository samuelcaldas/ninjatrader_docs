...
- (entry price – exit price) for short trades     |  | | --- | | Note:  This statistic may also display in selected Display Units (percent, points, pips or ticks).  To see the base calculation behind each execution, view the [Profit and Loss Calculation Modes](profit_and_loss_calculation_modes.md) page. | |

![tog_minus](tog_minus.gif)

|  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| Total net profit This statistic returns a monetary value representing a final cumulative profit of the all profitable trades and all unprofitable trades.     |  |  | | --- | --- | | Currency, Pips, Points, Ticks | SUM(gross profit and gross loss) of all trades | | Percentage | SUM((1 + gross profit in percent) \* ( 1 + gross loss in percent) - 1) of all trades |     |  | | --- | | Notes:
...
![tog_minus](tog_minus.gif)        Understanding Gross Loss
...
![tog_minus](tog_minus.gif)        Understanding Commission
...
![tog_minus](tog_minus.gif)        Understanding Profit Factor
...
![tog_minus](tog_minus.gif)        Understanding Max. Drawdown
...
![tog_minus](tog_minus.gif)        Understanding Sharpe Ratio
...
![tog_minus](tog_minus.gif)        Understanding Sortino Ratio
...
![tog_minus](tog_minus.gif)        Understanding Ulcer Index
...
![tog_minus](tog_minus.gif)        Understanding Probability
...
![tog_minus](tog_minus.gif)        Understanding Winning, Losing, Even, and Total Number of Trades
...
![tog_minus](tog_minus.gif)        Understanding Average Trade
...
![tog_minus](tog_minus.gif)        Understanding Average Winning Trade
...
![tog_minus](tog_minus.gif)        Understanding Average Losing Trade
...
![tog_minus](tog_minus.gif)        Understanding Ratio Avg Win / Avg Loss
...
![tog_minus](tog_minus.gif)        Understanding Maximum Consecutive Winners
...
![tog_minus](tog_minus.gif)        Understanding Maximum Consecutive Losers
...
![tog_minus](tog_minus.gif)        Understanding Average Time in Market
...
![tog_minus](tog_minus.gif)        Understanding Profit Per Month
...
![tog_minus](tog_minus.gif)        Understanding Max. Time to Recover
...
![tog_minus](tog_minus.gif)        Understanding Longest Flat Period
...
![tog_minus](tog_minus.gif)        Understanding Average MAE
...
![tog_minus](tog_minus.gif)        Understanding Average MFE
...
![tog_minus](tog_minus.gif)        Understanding Average ETD
...
![tog_minus](tog_minus.gif)        Understanding Cumulative Profit
...
![tog_minus](tog_minus.gif)        Understanding Entry, Exit, and Total Efficiency
