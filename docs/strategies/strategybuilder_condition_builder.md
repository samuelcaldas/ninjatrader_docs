...
Offsets by the specified amount of pips

Percent

Offsets a percentage value of the item's value. A value of 1 is equal to 100% where a value of 0.1 is equal to 10%.

Ticks

Offsets by the specified amount of ticks

Once the Offset type is selected, you must set the value Offset. In addition to the example below, you can see the "Checking for Volume Expansion" section below for another example that uses the Percent Offset type.     The following is an example and represents one of many possible combinations:     1. Expand the Price category and select the Close  2. Expand the Price category and select the High  3. Select the greater relational operator  4. Set the Bars ago parameter to a value of "1"  5. Set the Offset type parameter to Ticks  6. Set the Offset parameter to a value of "1"    Strategy_Builder_CB3     Once the OK button is pressed, a condition is created that would translate to the following:     "Current closing price is greater than the high price of 1 bar ago + 1 tick"
...
![Strategy Builder Cb5](../images/strategy_builder_cb5.png)
...
![Strategy Builder Cb10](../images/strategy_builder_cb10.png)

![Strategy Builder Cb9](../images/strategy_builder_cb9.png)

![Strategy Builder Cb6](../images/strategy_builder_cb6.png)
...
![Strategy Builder Cb12](../images/strategy_builder_cb12.png)

![Strategy Builder Cb8](../images/strategy_builder_cb8.png)
...
![Strategy Builder Cb22](../images/strategy_builder_cb22.png)

![Strategy Builder Cb21](../images/strategy_builder_cb21.png)

![Strategy Builder Cb20](../images/strategy_builder_cb20.png)

![Strategy Builder Cb19](../images/strategy_builder_cb19.png)

![Strategy Builder Cb18](../images/strategy_builder_cb18.png)

![Strategy Builder Cb16](../images/strategy_builder_cb16.png)

![Strategy Builder Cb17](../images/strategy_builder_cb17.png)

![Strategy Builder Cb14](../images/strategy_builder_cb14.png)

![Strategy Builder Cb13](../images/strategy_builder_cb13.png)

![Strategy Builder Cb11](../images/strategy_builder_cb11.png)

![Strategy Builder Cb7](../images/strategy_builder_cb7.png)

![Strategy Builder Cb4](../images/strategy_builder_cb4.png)

![Strategy Builder Cb24](../images/strategy_builder_cb24.png)

![Strategy Builder Cb1](../images/strategy_builder_cb1.png)