...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_disposebase_dispose.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX](sharpdx.htm) > [DisposeBase](sharpdx_disposebase.htm) >  SharpDX.DisposeBase.Dispose() | [Previous page](sharpdx_disposebase.htm) [Return to chapter overview](sharpdx_disposebase.htm) [Next page](sharpdx_disposebase_isdisposed.htm) |
