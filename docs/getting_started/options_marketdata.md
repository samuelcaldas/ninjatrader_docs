...
| Show Tick Replay | When enabled, allows "Tick Replay" to be configured from a data series menu.  Please see [Tick Replay](../operations/tick_replay.md) for more information. |
| Real-time |  |
...
| Enable market recording of playback | Enables or disables market data recording for use with the [Playback Connection](../operations/playback_connection.md) |
...
| Record live data as historical | Enables or disables the storage of incoming real-time [Chart](../operations/charts.md) data to your local PC for future historical data requests. If you are connected to a provider that supports historical data, disable this feature. |
| Download COT data at startup | Allows downloading of Commitment of Traders data for use with the [COT](../operations/cot.md) indicator |