...
![tog_minus](tog_minus.gif)        Creating `Series<T>` Objects
...
![tog_minus](tog_minus.gif)        How Bars Data is Referenced
...
```
![tog_minus](tog_minus.gif)        Using Bars Objects as Input to Indicator Methods
...
![tog_minus](tog_minus.gif)        True Event Driven OnBarUpdate() Method
...
![tog_minus](tog_minus.gif)        Accessing the Price Data in a Multi-Bars NinjaScript
...
![tog_minus](tog_minus.gif)        Entering, Exiting and Retrieving Position Information
...
3.
For [advanced order methods](advanced_order_handling.md), if you DO NOT specify a BarsInProgress , the order will be submitted to the current bars in progress updating.
