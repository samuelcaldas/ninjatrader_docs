...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_direct2d1_gradientstop.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1-1.htm) >  SharpDX.Direct2D1.GradientStop | [Previous page](sharpdx_direct2d1_geometrysink_setfillmode-1.htm) [Return to chapter overview](sharpdx_direct2d1-1.htm) [Next page](sharpdx_direct2d1_gradientstopcollection-1.htm) |
...
| Color | The [SharpDX.Color](sharpdx_color-1.htm) of the gradient stop. |