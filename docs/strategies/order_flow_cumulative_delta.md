...
Accumulates volume per session
...
Color and line settings for the candle body outline

Candle wick

Color and line settings for the candle wick

Color for down bars

Color for bars that have a close less than the open
