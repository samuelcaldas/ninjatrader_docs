...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](common.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) >  Common | [Previous page](alphabetical_reference.htm) [Return to chapter overview](language_reference_wip.htm) [Next page](adddataseries.htm) |
