...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\manage_database.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Instruments](instruments-1.htm) >  Managing Instruments | [Previous page](searching_for_instruments-1.htm) [Return to chapter overview](instruments-1.htm) [Next page](editing_instruments-1.htm) |
...
1. Press the "new" button which opens the [Instrument](editing_instruments-1.htm) window
--------------------------------------------------------------------------------------------------------------
...
Equities can be alternatively added by typing the symbol name into an open chart or Market Analyzer and pressing the "Enter" key on your keyboard. Please see the "How to change a Data Series" section of the [Working with Price Data](working_with_price_data-1.htm) page of the Help Guide for more information.
...
For more information on editing instruments please see the [Editing Instruments](editing_instruments-1.htm) section of the help guide.
