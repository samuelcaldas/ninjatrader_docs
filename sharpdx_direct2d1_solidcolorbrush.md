...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_solidcolorbrush.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) >  SharpDX.Direct2D1.SolidColorBrush | [Previous page](sharpdx_direct2d1_rendertarget_transform.htm) [Return to chapter overview](sharpdx_direct2d1.htm) [Next page](sharpdx_direct2d1_solidcolorbrush_color.htm) |
