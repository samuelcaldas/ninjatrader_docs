...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\zigzag.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [System Indicator Methods](indicators-1.htm) >  ZigZag | [Previous page](woodies_pivots-1.htm) [Return to chapter overview](indicators-1.htm) [Next page](tradinghours-1.htm) |
...
You can access methods within this indicator to determine the number of bars ago a zigzag high or low point occurred or the current zigzag value, it is only meaningful to work with in Calculate.OnBarClose mode for the [Calculate](calculate-1.htm) property.
