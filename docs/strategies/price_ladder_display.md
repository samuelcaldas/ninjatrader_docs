...
- Submit sell orders
- Modify sell orders
- Display the total contracts on the ask at their respective prices (also known as market depth)    SuperDOM_1    |  | | --- | | Note: To view market depth for equities the [[[Level II](../operations/level_ii.md) window must be used. |  Columns You can optionally configure additional Columns 4 to display other points of interest relative to the ladder display.    SuperDOM_2  By default, NinjaTrader will come pre-loaded with the following columns:
...
![[[tog_minus](../images/tog_minus.gif)        Understanding how market data is displayed
...
![[[tog_minus](../images/tog_minus.gif)        How to use the quick buttons at the bottom of the Price Ladder display
...
![[[tog_minus](../images/tog_minus.gif)        Understanding how position and profit & loss information is displayed
...
![[[tog_minus](../images/tog_minus.gif)        How to adjust the Price Ladder display
