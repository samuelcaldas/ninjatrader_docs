...
The following section outlines the requirements for proper TradeStation to NinjaTrader symbol mapping when using the Automated Trading Interface (both [[[DLL](../operations/dll_interface.md) or [[[Email interface](../operations/tradestation_email_integration.md)).
