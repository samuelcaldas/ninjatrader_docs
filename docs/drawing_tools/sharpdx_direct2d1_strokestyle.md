...
> **Tip:** For NinjaScript development purposes, when creating a StrokeStyle object you should use the [NinjaTrader.Core.Globals.D2DFactory](../language_reference/d2dfactory.md) property
