...
- Select Alerts    An Alert Dialog launched from the Market Analyzer will list any columns you have configured on your Market Analyzer to be used as alert condition objects.   Accessing Alerts from a Chart
- Right click on a Chart
- Select Alerts    An Alert Dialog launched from the Chart will list any chart objects (data series, indicators, drawing tools) you have configured on your Chart to be used as alert condition objects.
...
Define alert conditions to monitor

3.  Message

Define alert message details generated when alert condition is triggered
