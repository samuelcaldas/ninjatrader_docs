...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\chart_zorder.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [Charts](chart-1.htm) > [Rendering](rendering-1.htm) >  ZOrder | [Previous page](setzorder-1.htm) [Return to chapter overview](rendering-1.htm) [Next page](formatpricemarker-1.htm) |
...
|  |
| --- |
| Note:  The ZOrder index should NOT be set using this property. Please use the dedicated [SetZOrder()](setzorder-1.htm) for this purpose. |
