...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\enterlongstopmarket.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Strategy](strategy-1.htm) > [Order Methods](order_methods-1.htm) > [Managed Approach](managed_approach-1.htm) >  EnterLongStopMarket() | [Previous page](enterlongstoplimit-1.htm) [Return to chapter overview](managed_approach-1.htm) [Next page](entershort-1.htm) |
