...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\onmouseup.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Drawing Tool](drawing_tools-1.htm) >  OnMouseUp() | [Previous page](onmousemove-1.htm) [Return to chapter overview](drawing_tools-1.htm) [Next page](supportsalerts-1.htm) |
...
| dataPoint | A [ChartAnchor](chartanchor-1.htm) representing a point where the user is releasing the mouse |
