...
![tog_minus](tog_minus-1.gif)        Understanding the Output window display
...
![tog_minus](tog_minus-1.gif)        Understanding the dual tab view
...
![tog_minus](tog_minus-1.gif)        Searching and highlighting
...
![tog_minus](tog_minus-1.gif)        Clearing and saving output information
...
![tog_minus](tog_minus-1.gif)        Output window properties
...
![tog_minus](tog_minus-1.gif)        NinjaScript Utilization Monitor
