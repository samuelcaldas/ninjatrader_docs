...
![tog_minus](tog_minus.gif)        Understanding the General screen
...
![tog_minus](tog_minus.gif)        Understanding the Default properties screen
...
![tog_minus](tog_minus.gif)        Understanding the Additional data screen
...
![tog_minus](tog_minus.gif)        Understanding the Finish screen

|  |
| --- |
| Finish screen Layout Once you reach this screen you are finished with developing your strategy. Press the Finish button to compile your strategy which will then be ready for [backtesting](backtest_a_strategy.htm) or [live execution](running_ninjascript_strategies.htm).    Strategy_Builder_13 |