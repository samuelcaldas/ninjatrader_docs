...
![tog_minus](tog_minus-1.gif)        Understanding the Columns window
...
![tog_minus](tog_minus-1.gif)        How to add columns
...
![tog_minus](tog_minus-1.gif)        How to edit a column's parameters
...
![tog_minus](tog_minus-1.gif)        Understanding the APQ (Approximate Position in Queue) Column
...
![tog_minus](tog_minus-1.gif)        Understanding the Notes Column
...
![tog_minus](tog_minus-1.gif)        Understanding the Pulling/Stacking Column
...
![tog_minus](tog_minus-1.gif)        Understanding the Recent Bid/Ask Column
...
![tog_minus](tog_minus-1.gif)        Understanding the PnL Column
...
![tog_minus](tog_minus-1.gif)        Understanding the Volume Column
...
![tog_minus](tog_minus-1.gif)        How to remove columns
...
![tog_minus](tog_minus-1.gif)        Customize the display of columns
...
![tog_minus](tog_minus-1.gif)        Custom column development
