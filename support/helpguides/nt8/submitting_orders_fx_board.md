...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](submitting_orders_fx_board.htm) >>  **Navigation:**  [Operations](operations.htm) > [Order Entry](order_entry.htm) > [FX Board](fx_board.htm) >  Submitting Orders | [Previous page](working_with_instrument_tiles_fx_board.htm) [Return to chapter overview](fx_board.htm) [Next page](modifying_and_cancelling_orders_fx_board.htm) |

Submitting orders within the FX Board order entry window is both easy and efficient.  In addition to entry and exit orders the FX Board window also offers access to NinjaTrader  ATM Strategies. For more information on ATM Strategies please see the [ATM section](atm_strategy.htm) of the user help guide or attend one of our [free live training events](http://www.ninjatrader.com/webinars.php).
