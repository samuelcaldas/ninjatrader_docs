...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](isvaliddatapoint.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Common](common.htm) > [ISeries<T>](iseriest.htm) >  IsValidDataPoint() | [Previous page](getvalueat.htm) [Return to chapter overview](iseriest.htm) [Next page](isvaliddatapointat.htm) |
