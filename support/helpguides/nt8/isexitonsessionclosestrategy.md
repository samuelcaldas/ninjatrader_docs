...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](isexitonsessionclosestrategy.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Strategy](strategy.htm) >  IsExitOnSessionCloseStrategy | [Previous page](isadoptaccountpositionaware.htm) [Return to chapter overview](strategy.htm) [Next page](isfilllimitontouch.htm) |
