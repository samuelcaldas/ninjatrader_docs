...
![BasicEntry_27](../images/basicentry_27.png)
...
Closes the current open position and open a reverse position.
...
Please see the [Submitting Orders](submitting_orders_basic_entry.md) section for more information on using these buttons.

## Understanding the order control section

Order Controls The Order Control section of the Basic Entry is used to specify several attributes for a pending order to be submitted.  BasicEntry_5
