...
```csharp
![tog_minus](tog_minus.gif)        Understanding custom brushes
...
```csharp
![tog_minus](tog_minus.gif)        Using brushes defined on the user interface
...
![tog_minus](tog_minus.gif)        Using advanced brush types (SharpDX)
...
Converting to SharpDX Brush For convenience, you can convert a computed WPF Brush to a [SharpDX Brush](sharpdx_direct2d1_brush.md) using the [ToDxBrush(](dxextensions_todxbrush.md)) extension method.
...
Disposing DXBrush Since SharpDX Brushes reference unmanaged resources, these brushes should always be [disposed](sharpdx_disposebase.md) of after they have been used.
