...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\using_the_hot_list_analyzer.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Hot List Analyzer](hot_list_analyzer-1.htm) >  Using the Hot List Analyzer | [Previous page](hot_list_analyzer-1.htm) [Return to chapter overview](hot_list_analyzer-1.htm) [Next page](customizing_the_hot_list_analy-1.htm) |
...
![tog_minus](tog_minus-1.gif)       Understanding Hot Lists
