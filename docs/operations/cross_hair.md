...
> Enabling the Cross Hair  There are multiple ways to enable the Cross Hair within a chart window:    CrossHair_ChartIcon
...
- Use the default CTRL +Q [Hot Key](hot_key_manager.md)    The cursor icon within the chart toolbar will change to a cross hair icon, letting you know that Cross Hair is enabled on the chart.
...
- Use the default CTRL +G [Hot Key](hot_key_manager.md)    The cursor icon within the chart toolbar will change to a cross hair icon with a square border, letting you know that Global Cross Hair is enabled on the chart.    |  | | --- | | Tips:
...
![tog_minus](../images/tog_minus.gif)        How to use the Global Cross Hair
...
![tog_minus](../images/tog_minus.gif)        Cross Hair Options
