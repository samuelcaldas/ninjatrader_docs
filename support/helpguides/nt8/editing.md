...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](editing.htm) >>  **Navigation:**  [Operations](operations.htm) > [Historical Data](historical_data_manager.htm) >  Editing | [Previous page](exporting.htm) [Return to chapter overview](historical_data_manager.htm) [Next page](download.htm) |
