...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\cs0021.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Editor](editor-1.htm) > [Compile Error Codes](compile_error_codes-1.htm) >  CS0021 | [Previous page](cs0019-1.htm) [Return to chapter overview](compile_error_codes-1.htm) [Next page](cs0029-1.htm) |
