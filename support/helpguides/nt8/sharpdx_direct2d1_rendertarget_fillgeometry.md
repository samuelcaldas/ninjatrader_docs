...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_rendertarget_fillgeometry.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) > [RenderTarget](sharpdx_direct2d1_rendertarget.htm) >  SharpDX.Direct2D1.RenderTarget.FillGeometry() | [Previous page](sharpdx_direct2d1_rendertarget_fillellipse.htm) [Return to chapter overview](sharpdx_direct2d1_rendertarget.htm) [Next page](sharpdx_direct2d1_rendertarget_fillrectangle.htm) |
