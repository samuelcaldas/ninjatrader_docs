...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](attachedto.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Drawing Tool](drawing_tools.htm) >  AttachedTo | [Previous page](anchors.htm) [Return to chapter overview](drawing_tools.htm) [Next page](chartanchor.htm) |
