...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\working_with_templates.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Market Analyzer](market_analyzer-1.htm) >  Working with Templates | [Previous page](market_analyzer_properties-1.htm) [Return to chapter overview](market_analyzer-1.htm) [Next page](performance_tips-1.htm) |
...
![tog_minus](tog_minus-1.gif)        How to remove a Market Analyzer Template
