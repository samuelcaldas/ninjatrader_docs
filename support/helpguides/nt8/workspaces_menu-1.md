...
![tog_minus](tog_minus-1.gif)        Creating a workspace
...
![tog_minus](tog_minus-1.gif)        Saving a workspace
...
![tog_minus](tog_minus-1.gif)        Opening a workspace
...
![tog_minus](tog_minus-1.gif)        Closing a workspace
...
![tog_minus](tog_minus-1.gif)        Removing a workspace
...
![tog_minus](tog_minus-1.gif)        How to quickly switch between workspaces

|  |
| --- |
| Quickly Switching Between Workspaces Pressing SHIFT+F3 keys together will cycle to the next open workspace. |

![tog_minus](tog_minus-1.gif)        How to recover workspaces
