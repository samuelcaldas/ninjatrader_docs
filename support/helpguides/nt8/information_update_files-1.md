...
![tog_minus](tog_minus-1.gif)        Understanding order state files
...
![tog_minus](tog_minus-1.gif)        Understanding position update files
...
![tog_minus](tog_minus-1.gif)        Understanding connection state files
