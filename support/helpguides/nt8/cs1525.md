...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](cs1525.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Editor](editor.htm) > [Compile Error Codes](compile_error_codes.htm) >  CS1525 | [Previous page](cs1513.htm) [Return to chapter overview](compile_error_codes.htm) [Next page](nodoc.htm) |
