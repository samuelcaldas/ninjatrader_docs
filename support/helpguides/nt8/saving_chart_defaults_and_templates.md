...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](saving_chart_defaults_and_templates.htm) >>  **Navigation:**  [Operations](operations.htm) > [Charts](charts.htm) >  Saving Chart Defaults and Templates | [Previous page](working_with_automated_strateg.htm) [Return to chapter overview](charts.htm) [Next page](data_box.htm) |
...
![tog_minus](tog_minus.gif)        Understanding indicator default settings
