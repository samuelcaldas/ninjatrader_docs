...
![tog_minus](tog_minus.gif)        Quantity Type and TIF
...
![tog_minus](tog_minus.gif)        How to close a position
...
![tog_minus](tog_minus.gif)        Understanding core order objects
...
![tog_minus](tog_minus.gif)        Internal Order Handling Rules that Reduce Unwanted Positions
