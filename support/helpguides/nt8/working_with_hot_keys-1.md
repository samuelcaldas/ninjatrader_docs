...
![tog_minus](tog_minus-1.gif)        Understanding the Hot Keys window
...
![tog_minus](tog_minus-1.gif)        Assigning and Removing Hot Keys
...
![tog_minus](tog_minus-1.gif)        Understanding when Hot Keys are active
