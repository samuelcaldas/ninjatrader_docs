...
![Cicon Video Playbutton-1](../images/cicon_video_playbutton-1.png)

![Superdom 60](../images/superdom_60.png)
...
Allows the selection of a specific indicator to which to attach an order

Offset

Sets an offset value to allow an order to trail above or below an indicator plot

Modify toward last price only

Restricts an order to only move towards the last traded price as it follows an indicator plot, never further away