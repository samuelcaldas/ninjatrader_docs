...
PriceLevel.GetPrice():  Removed redundant [chartScale overload](pricelevels.md)
...
You can read more about the NinjaScript Folders in the "Managing scripts and folders" section of the [NinjaScript Explorer](ns_explorer.md) help guide article.
