...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](entering_on_one_time_frame_and.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Educational Resources](educational_resources.htm) > [Reference Samples](reference_samples.htm) > [Strategy](strategy2.htm) >  Entering on one time frame and exiting on another | [Previous page](backtesting_ninjascript_strate.htm) [Return to chapter overview](strategy2.htm) [Next page](getting_pnl_from_an_atm_strate.htm) |
