...
| [ToDirectWriteTextFormat()](../drawing_tools/simplefont_todirectwritetextformat.md) | Converts a SimpleFont object to a SharpDX compatible font which can be used for chart rendering. |
