...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\working_with_indicators_superdom.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Order Entry](order_entry-1.htm) > [SuperDOM](superdom-1.htm) >  Working with Indicators | [Previous page](superdom_templates-1.htm) [Return to chapter overview](superdom-1.htm) [Next page](properties_superdom-1.htm) |
...
The SuperDOM's [Price Ladder display](price_ladder_display-1.htm) has the ability to add any number of price action indicators which can be used to visualize and analyze indicator values in relation to the SuperDOM display, as well as attaching working orders to the indicator price level for a hand-free trade management system.
...
![tog_minus](tog_minus-1.gif)        Understanding how indicators are displayed
...
![tog_minus](tog_minus-1.gif)        How to remove an indicator
