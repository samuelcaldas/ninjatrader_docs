...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](connectionlosshandling.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Language Reference](language_reference_wip.htm) > [Strategy](strategy.htm) >  ConnectionLossHandling | [Previous page](closestrategy.htm) [Return to chapter overview](strategy.htm) [Next page](daystoload.htm) |
