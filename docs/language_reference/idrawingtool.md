...
> **Note:** For implementing a custom Drawing Tool project, please see the [DrawingTools](../drawing_tools/drawing_tools.md) section of this help guide.
...
- AttachedToType.Bars,
- AttachedToType.GlobalInstrument,
- AttachedToType.Indicator,
- AttachedToType.Strategy |
| DrawingState | The current [DrawingState](../drawing_tools/drawingstate.md) of the drawing tool |
...
| ZOrderType | An enum indicating the order in which the drawing tool will be drawn.    Possible values are:
