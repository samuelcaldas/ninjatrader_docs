...
```
![tog_minus](tog_minus.gif)        Can I have my Auto Trail loosen as I gain ticks in profit?
...
![tog_minus](tog_minus.gif)        Why don't the following ATM Strategy parameters work?
...
![tog_minus](tog_minus.gif)        Can I use the Auto Breakeven and Auto Trail strategies together?
...
![tog_minus](tog_minus.gif)        How do I add an ATM Strategy to an open position?
...
![tog_minus](tog_minus.gif)        Can I manually bracket a position without using an ATM Strategy?
...
![tog_minus](tog_minus.gif)        How do I make one target a "runner" so that it has a Stop Loss only and no Profit Target?

> If you want a target in your ATM Strategy to have a Stop Loss only then set the Profit Target to zero.

![tog_minus](tog_minus.gif)        What happens as one of my ATM orders are rejected?
