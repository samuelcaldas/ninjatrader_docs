...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\draw_ruler.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [Drawing](drawing-1.htm) >  Draw.Ruler() | [Previous page](riskreward-1.htm) [Return to chapter overview](drawing-1.htm) [Next page](ruler-1.htm) |
...
A [Ruler](ruler-1.htm) object that represents the draw object.
