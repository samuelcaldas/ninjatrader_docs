...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\working_with_price_series.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) >  Working with Price Series | [Previous page](working_with_pixel_coordinates-1.htm) [Return to chapter overview](educational_resources-1.htm) [Next page](reference_samples-1.htm) |
...
|  |  |
| --- | --- |
| [ISeries<T>](priceseries-1.htm) | Standard bar based price types such as closing, opening, high, low prices and volume |
| [Indicator](indicator-1.htm) | Calculated values based on price type values such as a simple moving average |
| Custom Historical [Series<T>](seriest-1.htm) | Custom calculated values that you wish to store and associate to each historical bar |
...
Please review the [Indicator Methods](indicators-1.htm) section for proper syntax for accessing different indicator values.