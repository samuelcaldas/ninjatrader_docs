...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\set_up7.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Educational Resources](educational_resources-1.htm) > [Developing Indicators](developing_indicators-1.htm) > [Intermediate - Historical Custom Data Series](intermediate_-_historical_cust-1.htm) >  Set Up | [Previous page](intermediate_-_historical_cust-1.htm) [Return to chapter overview](intermediate_-_historical_cust-1.htm) [Next page](entering_calculation_logic4-1.htm) |
...
1. Within the NinjaTrader [Control Center](control_center-1.htm), select the New menu, then select the NinjaScript Editor menu item.
...
The next page will allow you to configure one or more additional [Bars](bars-1.htm) objects for use by the indicator. For our purposes, we will leave this page blank and move forward by clicking the Next > button.
...
After this, click the Finish button, and the Indicator Wizard will generate a basic code structure implementing the parameters that you have set. You are now ready to move on to [entering calculation logic](entering_calculation_logic4-1.htm) in your code.