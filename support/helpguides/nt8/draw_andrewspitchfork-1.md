...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\draw_andrewspitchfork.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [Language Reference](language_reference_wip-1.htm) > [Common](common-1.htm) > [Drawing](drawing-1.htm) >  Draw.AndrewsPitchfork() | [Previous page](drawing-1.htm) [Return to chapter overview](drawing-1.htm) [Next page](andrewspitchfork-1.htm) |
...
An [AndrewsPitchfork](andrewspitchfork-1.htm) object that represents the draw object.
