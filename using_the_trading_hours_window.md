...
- [Strategy Analyzer](strategy_analyzer.md) window when configuring backtesting
- [Strategies tab](strategies_tab2.md) of the Control Center when starting a strategy
...
![tog_minus](tog_minus.gif)        Working with Trading Hour Templates
...
![tog_minus](tog_minus.gif)        Understanding session definitions
...
![tog_minus](tog_minus.gif)        Understanding trading holidays
