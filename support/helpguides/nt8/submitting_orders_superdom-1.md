...
![tog_minus](tog_minus-1.gif)        How to submit a limit order
...
![tog_minus](tog_minus-1.gif)        How to submit a stop-market order
...
![tog_minus](tog_minus-1.gif)        How to submit a stop-limit order
...
![tog_minus](tog_minus-1.gif)        How to submit an MIT (Market If Touched) order
...
![tog_minus](tog_minus-1.gif)        Understanding the OCO order (one cancels other) function
...
![tog_minus](tog_minus-1.gif)        How to submit orders with the Quick Buttons
