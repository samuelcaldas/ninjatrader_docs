...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\optimize_a_strategy.htm) >>  **Navigation:**  [Operations](operations-1.htm) > [Strategy Analyzer](strategy_analyzer-1.htm) >  Optimization | [Previous page](backtest_a_strategy-1.htm) [Return to chapter overview](strategy_analyzer-1.htm) [Next page](genetic_algorithm-1.htm) |
...
•Access to [historical data](data_by_provider-1.htm)

•Custom NinjaScript \*[strategy](strategy-1.htm)

•A thorough understanding of the Strategy Analyzer's [backtesting](backtest_a_strategy-1.htm) capabilities
...
![tog_minus](tog_minus-1.gif)        How to run an Optimization
