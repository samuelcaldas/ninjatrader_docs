...
The following properties are available for configuration within the Depth Chart Properties window:    DepthChart_Properties   Property Definitions
...
Sets how strong the gradient coloring effect should be, default is 0.5 - possible range of values is 0.0 - 1.0 (0.0 deactives the gradient)
...
Sets if the data tooltip is displayed
...
Sets the color for tracking buy orders

Sell orders

Sets the color for tracking sell orders
...
![Depthchart Properties](../images/depthchart_properties.png)