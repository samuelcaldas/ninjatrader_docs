...
> **Tips:**
- Please see the help guide topic on [Working with Brushes](working_with_brushes.md) for general information on using brushes and advanced brush concepts
- If you are using standard [Plots](plots.md) along with custom rendering from an indicator or strategy, you will need to ensure to call the base.OnRender() method for those plots to display.
