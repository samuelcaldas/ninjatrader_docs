...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](cs1502.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [Editor](editor.htm) > [Compile Error Codes](compile_error_codes.htm) >  CS1502 | [Previous page](cs1501.htm) [Return to chapter overview](compile_error_codes.htm) [Next page](cs1503.htm) |
