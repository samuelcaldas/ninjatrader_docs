...
![tog_minus](tog_minus.gif)        How to make chart price data comparisons
...
![tog_minus](tog_minus.gif)        How to offset an item value
...
![tog_minus](tog_minus.gif)        How to create time comparisons
