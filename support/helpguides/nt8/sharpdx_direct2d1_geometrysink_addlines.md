...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](sharpdx_direct2d1_geometrysink_addlines.htm) >>  **Navigation:**  [NinjaScript](ninjascript.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1.htm) > [GeometrySink](sharpdx_direct2d1_geometrysink.htm) >  SharpDX.Direct2D1.GeometrySink.AddLines() | [Previous page](sharpdx_direct2d1_geometrysink_addline.htm) [Return to chapter overview](sharpdx_direct2d1_geometrysink.htm) [Next page](sharpdx_direct2d1_geometrysink_beginfigure.htm) |
