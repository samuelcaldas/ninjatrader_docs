...
|  |  |
| --- | --- |
| << [Click to Display Table of Contents](.\sharpdx_direct2d1_brush_transform.htm) >>  **Navigation:**  [NinjaScript](ninjascript-1.htm) > [SharpDX SDK Reference](sharpdx_sdk_reference-1.htm) > [SharpDX.Direct2D1](sharpdx_direct2d1-1.htm) > [Brush](sharpdx_direct2d1_brush-1.htm) >  SharpDX.Direct2D1.Brush.Transform | [Previous page](sharpdx_direct2d1_brush_opacity-1.htm) [Return to chapter overview](sharpdx_direct2d1_brush-1.htm) [Next page](sharpdx_direct2d1_brushproperties-1.htm) |
...
A [Matrix3x2](sharpdx_matrix3x2-1.htm) transform applied to this brush.
